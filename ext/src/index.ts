 ...
 */
const modules: Array<{ new(): Module }> = [Time, Canvas, Audio, MouseMovementCheckbox, MouseMovementRest, MouseClickListener, FramePosition, BrowserInfo, ScreenResolution, Id, WebGL];
